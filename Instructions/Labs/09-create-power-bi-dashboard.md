...
27. Organize the tiles so that the the **Sales YTD** tile iis on the left, and the **Sales, Profit Margin** tile at the right.

    ![Picture 52](Linked_image_Files/09-create-power-bi-dashboard_image35.png)

### **Task 3: Edit tile details**
...
4. At the bottom of the pane, click **Save and Close**.
    ...
    *Typically, the data would refresh and change, triggering the alert. Due to the constraints of our environment, you will not test the alert in this exercise.
